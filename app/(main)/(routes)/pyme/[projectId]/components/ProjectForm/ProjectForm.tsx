...
export default function ProjectForm( props: ProjectFormProps) {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) =>{
    ...
    try {
      axios.patch(`/api/project/${project.id}`,values);
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                This is what the user will see as the project title.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                This is what the user will see as the project skills.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                This is what the user will see as the project description.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                This is what the user will see as the project start date.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        />
              ...
              <FormDescription>
                This is what the user will see as the project end Date.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <Button className="bg-[#0a2342]" type="submit">Save basic information</Button>
      </form>
    </Form>
   </div>
  )
