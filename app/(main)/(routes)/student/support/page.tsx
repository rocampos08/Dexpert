...
export default function ApplicantSupportChat() {
  const [messages, setMessages] = useState([
    {
      from: "bot",
      text: "Hi 👋 I'm here to help you apply to projects successfully. Ask me anything!",
    },
  ]);
          ...
          messages: [
            {
              role: "system",
              content:
                "You are a helpful assistant that supports applicants in navigating and applying to projects. Be friendly and concise.",
            },
            ...messages.map((msg) => ({
      ...
      <div className="px-4 pb-4 pt-2 space-y-2 border-t bg-white">
        ...
        >
          <input
            ...
            className="flex-1 px-4 py-2 rounded-full text-gray-700 border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-[#0a2342]"
          />
          <button
            type="submit"
            disabled={loading}
