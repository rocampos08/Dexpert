            ...
            {projects.map(({ id, imageUrl, skills, title, description, pyme }) => {
              ...
              return (
                <Link
                  ...
                  className="bg-gradient-to-br from-[#E3F2FD] via-white to-[#d7ecfd] text-gray-800 rounded-2xl p-4 flex flex-col justify-between transition-shadow hover:shadow-xl"
                >
