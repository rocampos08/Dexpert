...
export function ExperienceBanner() {
  ...
  return (
    <div className="z-20 w-full">
      <div className="z-20 grid items-start h-full p-6 py-20 md:text-left md:p-0 md:grid-cols-2">
        <LottieAnimation />
        <div className="flex flex-col justify-center max-w-md text-left">
          <h1 className=" text-2xl leading-tight text-left md:text-3xl md:mb-10 text-[#0A2243]">
            Experience is built,{" "}
            <TypeAnimation
          ...
          <p className="text-md mb-2 md:mb-8 md:text-lg text-[#2196F3]">
          ...
          <div className="flex items-center justify-start gap-3 md:gap-10">
            ...
            <Link
              href="/sign-up"
              className="px-3 border-[#0a2243] text-[#0a2243] py-2 transition-all border-2 cursor-pointer text-md w-fit rounded-xl hover:shadow-xl hover:shadow-[#0a2243]/30"
            >
              Go to projects
            </Link>
            ) : (
